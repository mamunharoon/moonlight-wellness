...
export const SessionComplete = () => {
  ...
  const handleReturnHome = () => {
    // Reset active morning flow trackers so dashboard switches to morning-post!
    setJourneyStep('');
    navigate('/');
  };
  ...
  return (
    <div className="min-h-[85vh] flex flex-col justify-between py-6 max-w-xl mx-auto space-y-10 select-none">
      ...
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-extrabold text-white leading-tight">Session Finished</h2>
